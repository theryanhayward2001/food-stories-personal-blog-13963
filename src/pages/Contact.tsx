        ...
        <form onSubmit={handleSubmit} className="space-y-6 animate-slide-up stagger-2">
          <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-6 py-3 rounded-full border border-input bg-background focus:outline-none focus:ring-2 focus:ring-primary"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={6}
                  className="w-full px-6 py-3 rounded-3xl border border-input bg-background focus:outline-none focus:ring-2 focus:ring-primary resize-none"
